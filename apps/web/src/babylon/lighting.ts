...
export function buildLighting(scene: Scene, engine: Engine, opts: BuildLightingOptions): void {
  ...
  // Hemispheric fill — bright but soft. Ground colour slightly warm so
  // upward reflections off the floor feel like real sunlight.
  ...
  // Tone-mapping mode enum lives on ImageProcessingConfiguration in Babylon 7.
  // 1 = ACES.
